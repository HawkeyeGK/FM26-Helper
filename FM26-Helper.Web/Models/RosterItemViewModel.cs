namespace FM26_Helper.Web.Models
{
    public class RosterItemViewModel
    {
        ...
        // Factory Method
        public static RosterItemViewModel FromPlayer(FM26_Helper.Shared.PlayerImportData player)
        {
            if (player.Snapshot == null) return new RosterItemViewModel { Name = player.PlayerName };

            var analysis = FM26_Helper.Shared.PlayerAnalyzer.Analyze(player.Snapshot);
        ...
        {
            var rank = FM26_Helper.Shared.ScoutingConstants.GetPersonalityRank(personality);
